...
```
mkdir -p $HOME/.eigenlayer/eigenda/mainnet/logs
mkdir -p $HOME/.eigenlayer/eigenda/mainnet/db
```
...
:::warning
Do not modify the docker-compose.yml file. Unexpected errors can result.
:::
